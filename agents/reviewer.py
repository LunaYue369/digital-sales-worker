...
def review_email(company: dict, subject: str, body: str, campaign_id: str, user_id: str = "") -> dict:
    ...
    user_msg = (
        ...
        '"approved" (boolean), "scores" (object with professionalism/accuracy/tone/cta_clarity/compliance/personalization, each 1-10), '
        '"overall_score" (number), "critical_issues" (array of strings), "suggestions" (array of strings), "verdict" (short string). '
        "Do NOT echo the email, target company, or any other fields back.\n\n"
